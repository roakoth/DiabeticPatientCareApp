...
public class AlarmMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent alarmIntent = new Intent(AlarmMain.this, AlarmReceiver.class);
        pendingIntent = PendingIntent.getBroadcast(AlarmMain.this, ALARM_REQUEST_CODE, alarmIntent, 0);
